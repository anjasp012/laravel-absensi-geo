                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    @csrf
                                    <input type="number" hidden name="role_id" value="2">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror" name="name" id="exampleInputEmail"
